...
def function(id):
    ...
    #print(questions);
    sql_c="select * from verbalquestions where sno in "+questions+";"
    ...
    for row in records:
            #print("Sno =", row[0],"question =", row[1],"option1 =", row[2],"option2 =", row[3],"option3 =", row[4],"option4 =", row[5],"ans =", row[6]);
    ...
    class Quiz:
        ...
        def display_result(self):
            ...
            sql_c="update student set verbalstatus='"+str(self.correct)+"' where id='"+id+"';";
            cursor.execute(sql_c);
            cnx.commit();
            print("sucess")
        ...
        def display_title(self):
            ...
            title = Label(gui, text="Verbal Section",
