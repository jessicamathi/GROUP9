...
def function(id):
    ...
    class Quiz:
        ...
        def display_result(self):
            ...
            sql_c="update student set pythonstatus='"+str(self.correct)+"' where id='"+id+"';";
            cursor.execute(sql_c);
            cnx.commit();
            print("sucess")
        ...
        def display_question(self):
            global q_no1
            #self.delete(1.0,END)
            q_no1 = Label(gui, width=99,text=question[self.q_no], justify="left",font=( 'ariel' ,16, 'bold' ), anchor= 'w', wraplength=1000 );
